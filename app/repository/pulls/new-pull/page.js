        ...
        <>
            <div style={{ display: "flex", flexDirection: "column", alignContent: "center", justifyContent: "center", padding: "30px 20%", gap: 30 }}>
                ...
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 20 }}>
                    ...
                    <div style={{ color: "#40bf63", display: "flex", justifyContent: "center", gap: 5, alignItems: "center" }}>
                        <Image
                            src={tick}
                            width={30}
                            height={30}
                ...
                <div>
                    ...
                    <input placeholder="#<Number>" style={{ color: "var(--font)", padding: "0 5px", width: "750px", height: "30px", background: "var(--button)", border: "0.5px solid var(--divider)", fontSize: "14px" }}></input>
                </div>
                ...
                <div>
                    <button className={styles.ForkButton} style={{ width: 200 }}> Create Pull Request</button>
